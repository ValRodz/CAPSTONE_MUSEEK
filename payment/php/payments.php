...
<body class="bg-[#161616] text-white">
    ...
    <aside class="sidebar bg-[#161616] border-r border-[#222222]" id="sidebar">
        ...
        <nav class="p-2">
            <ul class="space-y-1">
                ...
                <li>
                    <a href="payments.php" class="flex items-center gap-2 px-3 py-2 rounded-md bg-red-600 text-white">
                        <i class="fas fa-dollar-sign"></i>
                        <span>Payments</span>
                    </a>
                </li>
                <li>
                    <a href="instructors.php" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-[#222222] text-white">
                ...
                <li>
                    <div class="dropdown">
                        <a href="#" class="flex items-center gap-2 px-3 py-2 rounded-md hover:bg-[#222222] text-white">
    ...
    <main class="main-content min-h-screen" id="mainContent">
        <header class="flex items-center h-14 px-6 border-b border-[#222222]">
            <h1 class="text-xl font-bold ml-6">Payments</h1>
        </header>
    ...
    <div id="recordPaymentModal" class="modal">
        <div class="modal-content p-6">
            ...
            <form action="record_payment.php" method="post" class="space-y-4">
                <div>
