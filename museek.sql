...
INSERT INTO `admin_users` (`admin_id`, `username`, `email`, `password_hash`, `full_name`, `role`, `is_active`, `last_login`, `created_at`, `updated_at`) VALUES
	(1, 'admin', 'admin@museek.com', 'password', 'System Administrator', 'super_admin', 1, '2025-11-11 01:13:49', '2025-10-25 00:54:04', '2025-11-10 17:13:49'),
...
) ENGINE=InnoDB AUTO_INCREMENT=24 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Admin action audit trail';

-- Dumping data for table museek.audit_logs: ~22 rows (approximately)
...
-- Dumping data for table museek.bookings: ~52 rows (approximately)
INSERT INTO `bookings` (`BookingID`, `ClientID`, `StudioID`, `ServiceID`, `ScheduleID`, `InstructorID`, `Book_StatsID`, `CancellationReason`, `booking_date`) VALUES
	...
	(58, 14, 17, 7, 88, 10, 1, NULL, '2025-10-29 09:26:29'),
...
-- Dumping data for table museek.chatlog: ~41 rows (approximately)
...
-- Dumping data for table museek.clients: ~8 rows (approximately)
INSERT INTO `clients` (`ClientID`, `Name`, `Email`, `Phone`, `Password`, `V_StatsID`, `ProfileImg`) VALUES
	(1, 'Mike Tambasen', 'mike@gmail.com', '09223456678', 'Kyllanz79!', 1, NULL),
	(2, 'Jane Doe', 'jane@example.com', '09123456789', 'password123', 1, NULL),
	(3, 'John Smith', 'john@example.com', '09123456790', 'password456', 1, NULL),
	(4, 'Alice Johnson', 'alice@example.com', '09123456780', 'password789', 1, NULL),
	(5, 'Bob Brown', 'bob@example.com', '09123456781', 'password101', 1, NULL),
	(6, 'Jane Doe', 'jane@example.com', '09123456789', 'password123', NULL, NULL),
	(7, 'John Smith', 'john@example.com', '09123456790', 'password456', NULL, NULL),
	(14, 'Kyzzer Lanz R. Jallorina', 'kljallorina.chmsu@gmail.com', '09508199489', '12345678', 2, 'avatars/clients/client_14_1761537080.png');
...
) ENGINE=InnoDB AUTO_INCREMENT=35 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Registration documents and verification';

-- Dumping data for table museek.documents: ~19 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Secure document upload tokens';

-- Dumping data for table museek.document_upload_tokens: ~5 rows (approximately)
...
-- Dumping data for table museek.feedback: ~3 rows (approximately)
...
-- Dumping data for table museek.notifications: ~55 rows (approximately)
...
) ENGINE=InnoDB AUTO_INCREMENT=666997 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table museek.payment: ~44 rows (approximately)
...
-- Dumping data for table museek.schedules: ~62 rows (approximately)
...
INSERT INTO `studios` (`StudioID`, `ClientID`, `OwnerID`, `StudioName`, `Latitude`, `Longitude`, `Loc_Desc`, `Time_IN`, `Time_OUT`, `StudioImg`, `approved_by_admin`, `approved_at`, `is_active`, `is_featured`) VALUES
	...
	(8, NULL, 3, 'Harmony Sound Studio', '10.650674', '122.988642', 'Main St., Bacolod City, Negros Occidental', '08:00:00', '20:00:00', NULL, NULL, NULL, 1, 0),
...
-- Dumping structure for table museek.studio_chatbot_faq
CREATE TABLE IF NOT EXISTS `studio_chatbot_faq` (
  ...
  PRIMARY KEY (`id`),
  KEY `idx_owner_studio` (`owner_id`,`studio_id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

-- Dumping data for table museek.studio_chatbot_faq: ~0 rows (approximately)
...
-- Dumping data for table museek.studio_instructors: ~2 rows (approximately)
...
-- Dumping data for table museek.studio_owners: ~5 rows (approximately)
INSERT INTO `studio_owners` (`OwnerID`, `Name`, `Email`, `Phone`, `Password`, `V_StatsID`, `last_login`, `approved_by_admin`, `approved_at`, `subscription_status`, `subscription_plan_id`, `subscription_start`, `subscription_end`) VALUES
	...
	(3, 'Mike Tambasen', 'kyzzer.jallorina@gmail.com', '09123456789', 'admin3', 2, '2025-10-28 05:23:52', 1, '0000-00-00 00:00:00', 'active', 1, '2025-10-28 05:24:25', '2025-12-18 05:24:30'),
	...
	(9, 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'password', 2, NULL, 1, '2025-10-28 17:49:48', 'active', 1, '2025-10-29 00:00:00', '2025-11-29 00:00:00'),
	(10, 'Jert Jallorina', 'kyzzer.jallorina@gmail.com', '09105764655', '$2y$10$trWaNBasjYsyIW8lQTnwoejHa0tb.YyzTDn2eXeiclKhN70cHQW7G', 1, NULL, NULL, NULL, 'active', NULL, NULL, NULL);
...
CREATE TABLE IF NOT EXISTS `studio_registrations` (
  ...
  `registration_status` enum('pending','approved','rejected','requires_info') DEFAULT 'pending',
  `payment_status` enum('pending','completed','failed','refunded') DEFAULT 'pending',
...
) ENGINE=InnoDB AUTO_INCREMENT=13 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci COMMENT='Studio registration applications';

-- Dumping data for table museek.studio_registrations: ~9 rows (approximately)
INSERT INTO `studio_registrations` (`registration_id`, `studio_id`, `business_name`, `owner_name`, `owner_email`, `owner_phone`, `business_address`, `business_type`, `plan_id`, `subscription_duration`, `registration_status`, `payment_status`, `admin_notes`, `rejection_reason`, `reviewed_by`, `reviewed_at`, `approved_by`, `approved_at`, `submitted_at`, `updated_at`) VALUES
	(1, NULL, 'Test Studio (Approval)', 'Patricia Flores', 'patricia.flores@email.com', '09201115555', 'Bacolod City, Negros Occidental', 'recording_studio', 1, 'monthly', 'approved', 'pending', '', NULL, NULL, NULL, 1, '2025-10-29 14:38:08', '2025-10-25 07:20:18', '2025-10-29 06:38:08'),
	(2, NULL, 'JertPercz Audio', 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'Alijis St., Bacolod City, Negros Occidental', 'recording_studio', 1, 'monthly', 'rejected', 'pending', NULL, 'asdasd', NULL, '2025-10-29 14:28:50', 1, '2025-10-28 10:15:38', '2025-10-28 02:01:41', '2025-10-29 06:28:51'),
	(3, NULL, 'JertPercz Audio', 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'Alijis St., Bacolod City, Negros Occidental', 'recording_studio', 1, 'monthly', 'rejected', 'pending', NULL, 'Big weight', NULL, NULL, 1, '2025-10-28 13:49:50', '2025-10-28 02:37:17', '2025-10-28 05:49:50'),
	(4, NULL, 'JertPercz Audio', 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'Alijis St., Bacolod City, Negros Occidental', 'recording_studio', 1, 'monthly', 'rejected', 'pending', NULL, 'Big weight', NULL, NULL, 1, '2025-10-28 13:49:50', '2025-10-28 05:41:14', '2025-10-28 05:49:50'),
	(5, NULL, 'JertPercz Audio', 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'Alijis St., Bacolod City, Negros Occidental', 'recording_studio', 1, 'monthly', 'rejected', 'pending', NULL, 'Late', NULL, NULL, 1, '2025-10-28 16:03:30', '2025-10-28 05:49:19', '2025-10-28 08:03:30'),
	(6, NULL, 'JertPercz Audio', 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'Burgos Extension, Purok 7, Villamonte, Bacolod-1, Bacolod, Negros Island Region, 6100, Philippines', 'recording_studio', 1, 'monthly', 'approved', 'pending', 'Bulk approved', NULL, NULL, NULL, 1, '2025-10-29 01:14:11', '2025-10-28 07:45:25', '2025-10-28 17:14:11'),
	(8, 17, 'JertPercz Audio', 'Kyzzer Lanz R. Jallorina', 'zenon.draft@gmail.com', '09508199489', 'La Salleville, Villamonte, Bacolod-1, Bacolod, Negros Island Region, 6100, Philippines', 'recording_studio', 1, 'monthly', 'approved', 'completed', 'Bulk approved', NULL, NULL, '2025-10-29 14:28:52', 1, '2025-10-29 01:53:44', '2025-10-28 17:27:25', '2025-11-10 15:03:49'),
	(11, 3, 'Mike Tambasen MusicLab and Productions', 'Mike Tambasen', 'kyzzer.jallorina@gmail.com', '09123456789', 'Based on coordinates near Bacolod City, Negros Occidental', 'recording_studio', 1, 'monthly', 'pending', 'pending', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-10 15:21:21', '2025-11-10 15:21:21'),
	(12, 20, 'Aries Studio', 'Mike Tambasen', 'kyzzer.jallorina@gmail.com', '09123456789', 'Maribel Tyangson Gan Subdivision, La Carlota, Negros Occidental, Negros Island Region, 6130, Philippines', 'recording_studio', 1, 'monthly', 'pending', 'pending', NULL, NULL, NULL, NULL, NULL, NULL, '2025-11-10 16:36:35', '2025-11-10 16:36:35');
...
CREATE TABLE IF NOT EXISTS `studio_services` (
  ...
  UNIQUE KEY `uniq_service_single_studio` (`ServiceID`),
  KEY `StudioID` (`StudioID`),
...
-- Dumping data for table museek.studio_services: ~5 rows (approximately)
